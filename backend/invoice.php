...
$builder = new Builder(
    ...
    labelText: 'Generated by Flutter + PHP/Dompdf',
...
$logoPath = __DIR__ . "/logo.png"; // <-- put your company logo here
$logoBase64 = '';
...
$html .= '
    ...
    <div class="company">
        ...
        <pre>' . htmlspecialchars($companyAddress) . '</pre>
    </div>
    ...
    <div class="footer">
        Generated by Flutter + PHP/Dompdf | Page {PAGE_NUM} of {PAGE_COUNT}
    </div>
</body>
</html>
';
